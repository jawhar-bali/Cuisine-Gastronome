...
if(isset($_GET['error']))
$error="  Tapez le même mot de passe";
else $error="";
				...
				<label id="codeerror" name="codeerror" style="color:#eb1212"> <?php echo($error) ?> </label>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <input type="password" class="form-control" id="mdp1" placeholder="Mot de passe" 
					  name="mdp1"
					  >
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <input type="password" class="form-control" id="mdp2" placeholder="Confirmer mot de passe" 
					  name="mdp2"
					  >
                      <div class="input-group-append">
                        <span class="input-group-text">
				  ...
				  <div class="form-group">
                    <button class="btn btn-primary submit-btn btn-block" id="modifier" Type="submit" 
					name="modifier"
                    >Modifier</button>
                  </div>
